...
void loop()
{
   ...
   /* Serial.print(tiltX);  // echo the number readd to screen
    Serial.print(",");
    Serial.print(tiltY);  // echo the number readd to screen
    Serial.print(",");    
    Serial.print(tiltZ);  // echo the number readd to screen 
    /*Serial.print(",");*/    
    Serial.print(accel_x);  // echo the number readd to screen
    Serial.print(",");
    Serial.print(accel_y);  // echo the number readd to screen
    Serial.print(",");    
    Serial.print(accel_z);  // echo the number readd to screen 
